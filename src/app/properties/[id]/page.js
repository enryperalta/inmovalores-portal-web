...
export default function PropertyDetailPage({ params: paramsPromise }) {
    ...
    useEffect(() => {
        ...
        async function load() {
            try {
                const [propData, assignData] = await Promise.all([
                        ...
                        <div className="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
                            <div className="p-8 pb-4 text-center border-b border-gray-50 bg-[#f8fafc]">
                                <div className="w-full aspect-[4/3] mb-4 overflow-hidden rounded-xl bg-white border border-gray-100 flex items-center justify-center p-4 shadow-inner">
                                    <img src="http://localhost:8000/api/images/logo_redondo_inmovalores.png" className="w-full h-full object-contain" alt="Logo" />
                                </div>
                            </div>
